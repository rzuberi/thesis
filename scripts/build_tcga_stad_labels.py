...
ploidy/WGD/purity (PanCanAtlas ABSOLUTE). Output: data/tcga_stad_labels.csv."""
...
cdr = cdr[cdr["type"] == "STAD"][["bcr_patient_barcode", "OS", "OS.time",
...
req = urllib.request.Request(
    "https://www.cbioportal.org/api/molecular-profiles/stad_tcga_pan_can_atlas_2018_mutations/mutations/fetch?projection=SUMMARY",
    data=json.dumps({"sampleListId": "stad_tcga_pan_can_atlas_2018_all",
...
out = oac[cols]
out.to_csv(os.path.join(ROOT, "data", "tcga_stad_labels.csv"), index=False)
print(out.notna().sum())
